#!/usr/bin/env bash
version=200218
default_branch=MOODLE_38_STABLE
...
#--------------------------------------------------------------------------------------------------
echo " "
echo "Install QMoodle38 (v.$version)"
echo "---------------------------------------------------------------------------------------------------"
start_time=`date +%s`
home=$(pwd)
moodle_path=$1
...
#	git clone git@github.com:QMUL/moodle.git $moodle_path
