...
install_plugin git@github.com:ULCC-QMUL/moodle-filter_kaltura.git kaltura
...
install_plugin git@github.com:ULCC-QMUL/moodle-editor_tinymce_kalturamedia.git kalturamedia
...
install_plugin git@github.com:ULCC-QMUL/moodle-local_kaltura.git kaltura
...
install_plugin git@github.com:ULCC-QMUL/moodle-mod_kalvidassign.git kalvidassign MOODLE_36
install_plugin git@github.com:ULCC-QMUL/moodle-mod_kalvidpres.git kalvidpres
install_plugin git@github.com:ULCC-QMUL/moodle-mod_kalvidres.git kalvidres
...
install_plugin git@github.com:ULCC-QMUL/moodle-mod_subpage.git subpage QMU-develop-34
...
install_plugin git@github.com:PoetOS/moodle-mod_questionnaire.git questionnaire MOODLE_35_STABLE
